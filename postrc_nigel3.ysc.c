...
void __EntryFunction__()
{
	...
	while (0x00000001)
	{
		...
		if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()) && !unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0x00000000))
		{
			...
			{
				func_23(0x00000065, 0x00000001);
				unk_0xD8B681091EBE4064(joaat("sp_killed_al"), 0x00000001, 0x00000001);
				if (!unk_0xEAE0D21A50E6C7F4(Global_1B416.f_4889.f_17E, 0x00000005))
				{
					unk_0x5D96D8530B3D0904(&(Global_1B416.f_4889.f_17E), 0x00000005);
				}
				func_32();
			}
			else if (!func_22())
...
void func_1()
{
	...
	{
		case 0x00000000:
			if ((unk_0x1C0640BA9A7327B3() - iLocal_187) > 0x00001388 && unk_0xB87D13D0C064E9D1(iLocal_188, unk_0x16F2683693E537C9(), 0x00000001))
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 0x00000007, 0x00000000, 0x00000000, 0x00000000))
				{
					unk_0xE910A68AA670B4AA(iLocal_188);
					iLocal_21 = 0x00000001;
				}
			}
			else if ((unk_0x1C0640BA9A7327B3() - iLocal_187) > 0x00002EE0 && SYSTEM::VDIST2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0x00000001), unk_0x68F4C0EC296D3901(iLocal_188, 0x00000001)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 0x00000007, 0x00000000, 0x00000000, 0x00000000))
				{
					iLocal_21 = 0x00000001;
...
{
	iLocal_187 = unk_0x1C0640BA9A7327B3();
	func_21(&uLocal_22, 0x00000002, unk_0x16F2683693E537C9(), "TREVOR", 0x00000000, 0x00000001);
	func_21(&uLocal_22, 0x00000005, iLocal_188, "DINAPOLI", 0x00000000, 0x00000001);
...
int func_22()
{
	...
	fVar0 = 200f;
	if (SYSTEM::VDIST2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0x00000001), unk_0x68F4C0EC296D3901(iLocal_188, 0x00000001)) >= (fVar0 * fVar0) && !unk_0x0A059E0DB9253280(iLocal_188))
	{
		return 0x00000000;
	}
	return 0x00000001;
...
void func_26()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_29(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_27(iVar0) && (!func_15(0x0000000E) || Global_1AFFD))
			{
...
int func_31()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()) && !unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		...
		iVar2 = 0x00000000;
		while (iVar2 <= (iVar1 - 0x00000001))
		{
			if (uVar0[iVar2] != 0x00000000 && unk_0xC844350D5D58C99A(uVar0[iVar2]))
			{
