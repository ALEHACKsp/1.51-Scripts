...
void __EntryFunction__()
{
	...
	func_35(0x00000001);
	unk_0xAE1670DD12E839C3("les_1b_mcs_2", 0x00000008);
	func_18(0x00000001);
	...
	while (0x00000001)
	{
		...
		if (bLocal_56)
		{
			...
			func_1(0.1f, 0.1f, "NUMBER", 0x000000AB, 0x00000000);
		}
	...
	switch (iLocal_59)
	{
		...
		case 0x00000001:
			if (!unk_0x154B5473FBFD0156())
			{
				...
				unk_0xEF45C43067063F18(uLocal_51, 0.2f, 0.34f, 0.410001f, 0.69f, 0x00000064, 0x00000064, 0x00000064, 0x000000FF, 0x00000000);
				unk_0x3039591AD3E735CE(uLocal_54);
				if (bLocal_55)
				{
					unk_0x7E60C62A7CE58FC8(uLocal_52, "SET_TEXT");
					func_3("KEYNOTE_NAME");
					func_3("KEYNOTE_TITLE");
					unk_0x7E60D21B163E9D56();
					unk_0xEF45C43067063F18(uLocal_52, 0.5f, 0.5f, 1f, 1f, 0x00000064, 0x00000064, 0x00000064, 0x000000FF, 0x00000000);
				}
			}
			else
			{
...
void func_18(bool bParam0)
{
	...
	func_30("BREAKING_NEWS", &uLocal_52, 0x00000001);
	func_30("lifeinvader_presentation", &uLocal_51, 0x00000001);
...
void func_33(var uParam0, int iParam1)
{
	...
	*uParam0 = unk_0x7D6CA5F52B3748BF(-7000f, -7000f, -100f, 7000f, 7000f, 315f, 0x00000000, 0x00000001, 0x00000001, 0x00000001);
...
void func_43()
{
	...
	unk_0xE17FDF9E3068281B(&uLocal_51);
	unk_0xE17FDF9E3068281B(&uLocal_52);
...
void func_47(var uParam0)
{
	...
	uVar1 = func_49(uParam0->f_10);
	uVar2 = func_48(uParam0->f_10);
	iVar0 = 0x00000000;
	while (iVar0 < uParam0->f_11)
	{
		...
		{
			unk_0x7720CBBC7DD82563(uParam0->f_11[iVar0], uVar2, uVar1, -1000f);
		}
