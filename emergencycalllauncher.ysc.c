...
void __EntryFunction__()
{
	...
	func_39(&uLocal_45, 0x00000001, 0x00000000, "EMSDispatch", 0x00000000, 0x00000001);
	func_38();
	while (0x00000001)
	{
...
void func_3()
{
	if (func_6())
	{
		MemCopy(&uLocal_210, {func_5()}, 0x00000006);
		if (unk_0x8A22C4C08282BF26(unk_0x12AB0310C2281427(&uLocal_210)) == 0x00000000)
		{
			func_4();
		}
		else
		{
			Global_786A = 0x00000001;
		}
	}
	else
	{
		Global_786A = 0x00000000;
	}
}
...
void func_7()
{
	...
	{
		case 0x00000000:
			if ((((((func_35(0x00000082) && func_33(unk_0xD803B885F5E47A62()) != 0x000000C0) && func_33(unk_0xD803B885F5E47A62()) != 0x000000BE) && func_33(unk_0xD803B885F5E47A62()) != 0x000000BF) && func_33(unk_0xD803B885F5E47A62()) != 0x000000E1) && func_33(unk_0xD803B885F5E47A62()) != 0x000000E2) && func_33(unk_0xD803B885F5E47A62()) != 0x000000E3)
			{
				if (Global_7919)
				{
					iLocal_217 = 0x0000000B;
				}
				else
				{
					iLocal_217 = 0x00000002;
				}
				if (!Global_786A)
				{
					if (func_31())
					{
						if (func_8(&uLocal_45, 0x00000082, "LOCAUD", "LOC_CALLQ", iLocal_217, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0x00000000, 0x00000000, 0x00000000, 0x00000000))
						{
							if (!func_6())
							{
								...
								SYSTEM::START_NEW_SCRIPT("emergencycall", 0x00000200);
							}
							iLocal_44 = 0x00000001;
						}
					}
					else if (func_8(&uLocal_45, 0x00000082, "LOCAUD", "LOC_CALLQ", iLocal_217, "CELL_601", "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0x00000000, 0x00000000, 0x00000000, 0x00000000))
					{
						if (!func_6())
						{
							unk_0x92DCE5C81176D2B4("emergencycall");
		...
		case 0x00000001:
			if (unk_0x8A22C4C08282BF26(joaat("emergencycall")) == 0x00000000)
			{
				if (!func_35(0x00000082))
				{
...
{
	func_30(uParam0, iParam1, sParam2, iParam10, iParam11, 0x00000000);
...
int func_31()
{
	if (Global_28006E)
	{
		...
		{
			if (Global_300000 || func_32(0x00000000))
			{
				return 0x00000001;
			}
		}
	...
	if (Global_28006D)
	{
		if (func_26(0x00000000))
		{
			if (Global_380000 || func_32(0x00000000))
			{
				return 0x00000001;
			}
		}
