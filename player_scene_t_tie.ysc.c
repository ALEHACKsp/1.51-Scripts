...
void __EntryFunction__()
{
	...
	func_20();
	func_16();
	while (iLocal_67 && func_6(0x00000004, 0x00000000))
	{
		SYSTEM::WAIT(0x00000000);
		switch (iLocal_65)
		{
...
int func_2()
{
	...
	fVar0 = SYSTEM::VDIST2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0x00000001), vLocal_70);
	if (fVar0 > (100f * 100f))
	{
		return 0x00000001;
	}
...
int func_6(int iParam0, int iParam1)
{
	...
	if (!unk_0x991B1F0980C62628())
	{
		...
		else if (iParam1 == func_7(Global_180A1) && iParam1 != 0x00000000)
		{
...
void func_10()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_13(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_11(iVar0) && (!func_15(0x0000000E) || Global_1AFFD))
			{
...
void func_17()
{
	func_18((Global_180A3 - 0x00000001));
}
...
void func_20()
{
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0x00000000)
		{
			iLocal_68[iVar0] = unk_0x36F2404464202779(0x0000001A, iLocal_69[iVar0], vLocal_70 + vLocal_72[iVar0 /*3*/], 0f, 0x00000001, 0x00000001);
			unk_0xC023D1C4BF532815(iLocal_68[iVar0], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 0x00000002, 0x00000001);
			unk_0xC743BD39A24D0583(iLocal_68[iVar0], 0x00000000);
			if (iLocal_66 == 0x00000120)
			{
				unk_0x64F9F278AB9DCA2C(iLocal_68[iVar0], 0x00000003, 0x00000001, 0x00000000, 0x00000000);
				unk_0x64F9F278AB9DCA2C(iLocal_68[iVar0], 0x00000004, 0x00000000, 0x00000000, 0x00000000);
			}
			else
			{
				unk_0xC743BD39A24D0583(iLocal_68[iVar0], 0x00000000);
			...
			unk_0x3E8E48829F3C7624(iLocal_68[iVar0], &cLocal_75, &(Local_80[iVar0 /*8*/]), vLocal_70 + vLocal_72[iVar0 /*3*/], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 1000f, -8f, 0xFFFFFFFF, iLocal_81, 0f, 0x00000002, 0x00000000);
			unk_0xF895E10BF4C72645(iLocal_68[iVar0], 0x00000000, 0x00000000);
			unk_0xFADC0A217229F6B5(iLocal_68[iVar0], 0x00000001);
			unk_0x9DD8618CA5BF832D(iLocal_68[iVar0], 0x00000037, 0x00000001);
			if (iLocal_83[iVar0] > 0x00000000)
			{
				unk_0x9F3FF84D9E7E76F7(iLocal_68[iVar0], 0x00000001, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x78023EC6208DCB12(iLocal_68[iVar0], 0x00000001, 0.81f, 0.733f, 0x00000004);
				unk_0x78023EC6208DCB12(iLocal_68[iVar0], 0x00000000, 0.94f, 0.59f, 0x00000003);
				unk_0x78023EC6208DCB12(iLocal_68[iVar0], 0x00000003, 0.24f, 0.62f, 0x00000004);
				unk_0x78023EC6208DCB12(iLocal_68[iVar0], 0x00000002, 0f, 0.15f, 0x00000002);
				unk_0x78023EC6208DCB12(iLocal_68[iVar0], 0x00000005, 0.46f, 0.853f, 0x00000003);
				unk_0x78023EC6208DCB12(iLocal_68[iVar0], 0x00000004, 0.308f, 0.786f, 0x00000003);
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 0x00000003, 0.375f, 0.398f, 0f, 1f, 0xFFFFFFFF, 0f, "BasicSlash");
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 0x00000003, 0.5f, 0.6f, 0f, 1f, 0xFFFFFFFF, 0f, "BasicSlash");
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 0x00000003, 0.6f, 0.25f, 50f, 0.5f, 0xFFFFFFFF, 0f, "BasicSlash");
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 0x00000003, 0.65f, 0.325f, 50f, 0.5f, 0xFFFFFFFF, 0f, "BasicSlash");
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 0x00000000, 0.58f, 0.704f, 0f, 1f, 0xFFFFFFFF, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_82)
	{
		if (iLocal_83[iVar0] > 0x00000000)
		{
			...
			fVar10 = 1f;
			fVar11 = -1f;
			iLocal_82[iVar0] = unk_0x1776B2F0999C29AC(iLocal_83[iVar0], vLocal_70 + vLocal_84[iVar0 /*3*/], vVar3, vVar4, fVar5, fVar6, fVar7, fVar8, fVar9, fVar10, fVar11, 0x00000000, 0x00000000, 0x00000000);
			SYSTEM::WAIT(0x00000000);
		}
		iVar0++;
	}
...
void func_22()
{
	...
	switch (iLocal_66)
	{
		case 0x00000118:
			...
			StringCopy(&(Local_80[0x00000000 /*8*/]), "Dead_A", 32);
			StringCopy(&(Local_80[0x00000001 /*8*/]), "Dead_D", 32);
			StringCopy(&(Local_80[0x00000002 /*8*/]), "Dead_E", 32);
			StringCopy(&(Local_80[0x00000003 /*8*/]), "Dead_G", 32);
			vLocal_72[0x00000000 /*3*/] = { 14.613f, 8.4563f, 0.9751f };
			vLocal_72[0x00000001 /*3*/] = { 10.6489f, 8.6708f, 0.7701f };
			vLocal_72[0x00000002 /*3*/] = { 6.3982f, 1.4604f, 1.1f };
			vLocal_72[0x00000003 /*3*/] = { 4.2327f, 5.864f, (0.9f - 0.15f) };
			vLocal_73[0x00000000 /*3*/] = { 0f, 0f, 23.047f };
			vLocal_73[0x00000001 /*3*/] = { 0f, 0f, 97.2582f };
			vLocal_73[0x00000002 /*3*/] = { 0f, 0f, 34.2158f };
			vLocal_73[0x00000003 /*3*/] = { 0f, 0f, 61.2158f };
			iLocal_69[0x00000000] = joaat("g_m_y_lost_01");
			iLocal_69[0x00000001] = joaat("g_m_y_lost_01");
			iLocal_69[0x00000002] = joaat("g_m_y_lost_02");
			iLocal_69[0x00000003] = joaat("g_m_y_lost_03");
			iLocal_81 = 0x00280000;
			iLocal_74[0x00000000] = 0x00000001;
			iLocal_74[0x00000001] = 0x00000001;
			iLocal_74[0x00000002] = 0x00000001;
			iLocal_74[0x00000003] = 0x00000001;
			iLocal_83[0x00000000] = 0x00000456;
			iLocal_83[0x00000001] = 0x00000456;
			iLocal_83[0x00000002] = 0x00000456;
			iLocal_83[0x00000003] = 0x00000456;
			vLocal_84[0x00000000 /*3*/] = { Vector(0.37364f, -1445.534f, 2803.76f) - vLocal_70 + Vector(0.1f, 0f, 0f) };
			vLocal_84[0x00000001 /*3*/] = { Vector(0.28778f, -1444.863f, 2800.022f) - vLocal_70 + Vector(0.1f, 0f, 0f) };
			vLocal_84[0x00000002 /*3*/] = { Vector(0.6045f, -1452.404f, 2795.934f) - vLocal_70 + Vector(0.1f, 0f, 0f) };
			vLocal_84[0x00000003 /*3*/] = { Vector(0.28483f, -1448.033f, 2794.301f) - vLocal_70 + Vector(0.1f, 0f, 0f) };
			iLocal_83[0x00000004] = 0x000003F7;
			iLocal_83[0x00000005] = 0x000003F7;
			vLocal_84[0x00000004 /*3*/] = { vLocal_84[0x00000000 /*3*/] + vLocal_84[0x00000002 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x79833B02DBD2A244(0.5f, 0.5f), unk_0x79833B02DBD2A244(0.5f, 0.5f)) };
			vLocal_84[0x00000005 /*3*/] = { vLocal_84[0x00000001 /*3*/] + vLocal_84[0x00000002 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x79833B02DBD2A244(0.5f, 0.5f), unk_0x79833B02DBD2A244(0.5f, 0.5f)) };
			break;
		
		default:
			StringCopy(&cLocal_75, "", 32);
			StringCopy(&(Local_80[0x00000000 /*8*/]), "", 32);
			StringCopy(&(Local_80[0x00000001 /*8*/]), "", 32);
			StringCopy(&(Local_80[0x00000002 /*8*/]), "", 32);
			StringCopy(&(Local_80[0x00000003 /*8*/]), "", 32);
			iLocal_69[0x00000000] = 0x00000000;
			vLocal_72[0x00000000 /*3*/] = { 0f, 0f, 0f };
			vLocal_73[0x00000000 /*3*/] = { 0f, 0f, 0f };
			iLocal_69[0x00000001] = 0x00000000;
			vLocal_72[0x00000001 /*3*/] = { 0f, 0f, 0f };
			vLocal_73[0x00000001 /*3*/] = { 0f, 0f, 0f };
			iLocal_69[0x00000002] = 0x00000000;
			vLocal_72[0x00000002 /*3*/] = { 0f, 0f, 0f };
			vLocal_73[0x00000002 /*3*/] = { 0f, 0f, 0f };
			iLocal_69[0x00000003] = 0x00000000;
			vLocal_72[0x00000003 /*3*/] = { 0f, 0f, 0f };
			vLocal_73[0x00000003 /*3*/] = { 0f, 0f, 0f };
			iLocal_81 = 0x00000000;
			iLocal_74[0x00000000] = 0xFFFFFFFF;
			iLocal_74[0x00000001] = 0xFFFFFFFF;
			iLocal_74[0x00000002] = 0xFFFFFFFF;
			iLocal_74[0x00000003] = 0xFFFFFFFF;
			iLocal_83[0x00000000] = 0xFFFFFFFF;
			iLocal_83[0x00000001] = 0xFFFFFFFF;
			iLocal_83[0x00000002] = 0xFFFFFFFF;
			iLocal_83[0x00000003] = 0xFFFFFFFF;
			iLocal_83[0x00000004] = 0xFFFFFFFF;
			iLocal_83[0x00000005] = 0xFFFFFFFF;
			break;
	}
}
