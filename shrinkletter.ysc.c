...
void __EntryFunction__()
{
	...
	unk_0xD7992BEF7A9D109E("REPORT", 0x00000000);
	...
	while (0x00000001)
	{
		switch (iLocal_52)
		{
			...
			case 0x00000001:
				func_51(0x00000001, 0x00000001, 0x00000001, 0x00000000, 0x00000000, 0x00000000);
				...
				unk_0xD7992BEF7A9D109E("REPORT", 0x00000003);
				...
				func_12(&iLocal_72);
				func_11(&iLocal_72, 0x00000000, 0x00000000, 0x00000000, 0x00000001);
				func_10(&iLocal_72, "CONTINUE", 0x00000002, 0x000000C9, 0x00000001, 0x00000001, 0x00000000);
				func_9(&iLocal_72, 0x00000001);
				func_8(&iLocal_72, 0x00000001);
				if (unk_0x757EF87A33649210())
				{
					...
					while (!unk_0x0F1CCD77290EE12F())
					{
						...
						unk_0x6567AE843FADBA94(iLocal_53, 0x000000FF, 0x000000FF, 0x000000FF, 0x000000FF, 0x00000000);
						SYSTEM::WAIT(0x00000000);
					}
				}
				func_43();
			...
			case 0x00000002:
				unk_0xD9ACBBA59FD5A09E(0x00000001);
				unk_0x6567AE843FADBA94(iLocal_53, 0x000000FF, 0x000000FF, 0x000000FF, 0x000000FF, 0x00000000);
				func_1(&iLocal_72, 0x43480000, 0x00000001, 0x00000000, 0x00000001, 0x3F800000);
			...
			case 0x00000003:
				...
				func_51(0x00000000, 0x00000001, 0x00000001, 0x00000000, 0x00000000, 0x00000000);
...
void func_1(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_6(iParam0->f_1, 0x00000100) || (func_6(iParam0->f_1, 0x00002000) && unk_0xB8E3620B82AD47D7(0x00000002)))
	{
		...
		if (unk_0x0EFF6B4415DAF4A1())
		{
			...
			unk_0x1200CC973A2399C8(func_6(iParam0->f_1, 0x00001000));
			unk_0x7E60D21B163E9D56();
		}
		iVar5 = 0x00000000;
		iVar6 = 0x00000000;
		while (iVar6 < iParam0->f_7B)
		{
			...
			if (bVar4)
			{
				if (unk_0x7E60C62A7CE58FC8(*iParam0, "SET_DATA_SLOT"))
				{
					...
					if (unk_0x0EFF6B4415DAF4A1())
					{
						if (func_6(iParam0->f_1, 0x00001000))
						{
		...
		fVar8 = func_4(bParam4, func_4(func_6(iParam0->f_1, 0x00000020), 1f, 0f), -1f);
		...
		unk_0x7E60D21B163E9D56();
		func_3(&(iParam0->f_1), 0x00000100);
		func_2(&(iParam0->f_1), 0x00000080);
	}
...
void func_8(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		func_3(&(iParam0->f_1), 0x00000010);
	}
	else
	{
		func_2(&(iParam0->f_1), 0x00000010);
	}
}
...
void func_9(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		func_3(&(iParam0->f_1), 0x00000400);
	}
	else
	{
		func_2(&(iParam0->f_1), 0x00000400);
	}
}
...
int func_10(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar1 < 0x00000008)
	{
		...
		iParam0->f_2[iVar1 /*15*/].f_C = 0x00000000;
		iParam0->f_2[iVar1 /*15*/].f_D = 0x00000000;
		iParam0->f_2[iVar1 /*15*/].f_E = 0x00000000;
		iParam0->f_2[iVar1 /*15*/].f_3[0x00000000 /*2*/] = iParam2;
		iParam0->f_2[iVar1 /*15*/].f_3[0x00000000 /*2*/].f_1 = iParam3;
		if (iParam4 == 0x00000001)
		{
			unk_0x5D96D8530B3D0904(&(iParam0->f_2[iVar1 /*15*/].f_D), 0x00000000);
		}
...
void func_11(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam1)
	{
		func_3(&(iParam0->f_1), 0x00000020);
	}
	if (unk_0x83D8570832F172A7(*iParam0))
	{
		func_3(&(iParam0->f_1), 0x00000001);
		if (bParam2)
		{
			unk_0x5461A9D388F592B4(*iParam0, 0x00000001);
		}
	}
	if (unk_0x0EFF6B4415DAF4A1())
	{
		if (bParam3)
		{
			func_3(&(iParam0->f_1), 0x00001000);
		}
	}
	if (bParam4)
	{
		func_3(&(iParam0->f_1), 0x00002000);
	}
}
...
int func_14(var uParam0, int iParam1)
{
	if (!unk_0x150F98BB5AE5F9A7(uParam0))
	{
		if (*uParam0)
		{
			if (unk_0xB45EDD00181AF3F2() != 0x00000000 && iParam1)
			{
...
struct<4> func_20(var uParam0)
{
	...
	iVar1 = unk_0x09AC81E49EA267F7(0x00000001, 0x00000018);
	uParam0->f_F = iVar1;
...
struct<4> func_21(var uParam0)
{
	...
	if (((func_22(0x0000006E) || func_22(0x0000005F)) || func_22(0x0000006A)) || func_22(0x0000006B))
	{
		StringCopy(&(uParam0->f_E), "Y", 4);
		StringConCat(&Var0, "Y", 16);
		iVar1 = unk_0x09AC81E49EA267F7(0x00000001, 0x0000000B);
	}
	else
	{
		StringCopy(&(uParam0->f_E), "N", 4);
		StringConCat(&Var0, "N", 16);
		iVar1 = unk_0x09AC81E49EA267F7(0x00000001, 0x0000000C);
	}
...
struct<4> func_23(var uParam0)
{
	...
	unk_0x6FB46C25CCB7E6D5(joaat("num_rndpeople_completed"), &iVar2, 0xFFFFFFFF);
	unk_0x6FB46C25CCB7E6D5(joaat("num_rndevents_completed"), &iVar3, 0xFFFFFFFF);
	iVar4 = (iVar2 + iVar3);
	if (iVar4 > 0x0000000A)
	{
	...
	iVar1 = unk_0x09AC81E49EA267F7(0x00000001, 0x0000000D);
...
struct<4> func_24(var uParam0)
{
	...
	if ((((((((func_25(0x00000001, 0x00000001) > 0x00000032 && func_25(0x00000001, 0x00000002) > 0x00000032) && func_25(0x00000001, 0x00000003) > 0x00000032) && func_25(0x00000000, 0x00000001) > 0x00000032) && func_25(0x00000000, 0x00000002) > 0x00000032) && func_25(0x00000000, 0x00000003) > 0x00000032) && func_25(0x00000002, 0x00000001) > 0x00000032) && func_25(0x00000002, 0x00000002) > 0x00000032) && func_25(0x00000002, 0x00000003) > 0x00000032)
	{
...
struct<4> func_28(var uParam0)
{
	...
	if (func_29(0x0000012C, 0x00000001))
	{
...
struct<4> func_30(var uParam0)
{
	...
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_number_stolen_cop_vehicle"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_number_stolen_cars"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_number_stolen_bikes"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_number_stolen_boats"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_number_stolen_helis"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_number_stolen_quadbikes"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_number_stolen_bicycles"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_number_stolen_cop_vehicle"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_number_stolen_cars"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_number_stolen_bikes"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_number_stolen_boats"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_number_stolen_helis"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_number_stolen_quadbikes"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_number_stolen_bicycles"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_number_stolen_cop_vehicle"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_number_stolen_cars"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_number_stolen_bikes"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_number_stolen_boats"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_number_stolen_helis"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_number_stolen_quadbikes"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_number_stolen_bicycles"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	if (iVar3 >= 0x00000064)
	{
...
struct<4> func_31(var uParam0)
{
	...
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_kills_innocents"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_kills_innocents"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_kills_innocents"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	if (iVar3 >= 0x00000064)
	{
...
struct<4> func_32(var uParam0)
{
	...
	unk_0x6FB46C25CCB7E6D5(joaat("time_spent_on_stockmarket"), &iVar2, 0x00000000);
	if (iVar2 >= 0x0001D4C0)
	{
...
struct<4> func_33(var uParam0)
{
	...
	if (func_34(0x00000008) && func_34(0x00000005))
	{
...
int func_34(int iParam0)
{
	...
	{
		return unk_0xEAE0D21A50E6C7F4(Global_1B416.f_46B2.f_AF[iParam0 /*19*/].f_12, 0x00000000);
	}
	return 0x00000000;
}
...
struct<4> func_35(var uParam0)
{
	...
	if ((func_36(0x00000001) > 0x00000000 || func_36(0x00000000) > 0x00000000) || func_36(0x00000002) > 0x00000000)
	{
...
int func_36(int iParam0)
{
	...
	{
		case 0x00000000:
			return Global_1B416.f_273C.f_5A[0x00000000];
			break;
		
		case 0x00000001:
			return Global_1B416.f_273C.f_5A[0x00000001];
			break;
		
		case 0x00000002:
			return Global_1B416.f_273C.f_5A[0x00000002];
			break;
	}
	return 0x00000000;
}
...
struct<4> func_37(var uParam0)
{
	...
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_lap_danced_bought"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_lap_danced_bought"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_lap_danced_bought"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_money_spent_in_strip_clubs"), &iVar4, 0x00000000);
	iVar5 = (iVar5 + iVar4);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_money_spent_in_strip_clubs"), &iVar4, 0x00000001);
	iVar5 = (iVar5 + iVar4);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_money_spent_in_strip_clubs"), &iVar4, 0x00000002);
	iVar5 = (iVar5 + iVar4);
	if (iVar3 >= 0x00000003 || iVar5 >= 0x00000064)
	{
...
struct<4> func_38(var uParam0)
{
	...
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_money_total_spent"), &iVar2, 0x00000000);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_money_total_spent"), &iVar2, 0x00000001);
	iVar3 = (iVar3 + iVar2);
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_money_total_spent"), &iVar2, 0x00000002);
	iVar3 = (iVar3 + iVar2);
	if (iVar3 >= 0x000F4240)
	{
		StringCopy(&(uParam0->f_3), "SP", 8);
		StringConCat(&Var0, "SP", 16);
		iVar1 = unk_0x09AC81E49EA267F7(0x00000001, 0x0000000E);
	}
	else
	{
...
struct<4> func_39(var uParam0)
{
	...
	iVar2 = 0x00000000;
	iVar4 = 0x00000000;
	unk_0x6FB46C25CCB7E6D5(joaat("sp0_total_playing_time"), &iVar4, 0x00000000);
	unk_0x6FB46C25CCB7E6D5(joaat("sp1_total_playing_time"), &iVar3, 0x00000001);
	if (iVar3 > iVar4)
	{
		iVar4 = iVar3;
		iVar2 = 0x00000001;
	}
	unk_0x6FB46C25CCB7E6D5(joaat("sp2_total_playing_time"), &iVar3, 0x00000002);
	if (iVar3 > iVar4)
	{
		iVar4 = iVar3;
		iVar2 = 0x00000002;
...
struct<4> func_40(var uParam0)
{
	...
	if (func_22(0x00000087))
	{
		StringCopy(&(uParam0->f_1), "M", 4);
		StringConCat(&Var0, "M", 16);
		iVar1 = unk_0x09AC81E49EA267F7(0x00000001, 0x0000000B);
	}
	else if (func_22(0x00000088))
	{
		StringCopy(&(uParam0->f_1), "T", 4);
		StringConCat(&Var0, "T", 16);
		iVar1 = unk_0x09AC81E49EA267F7(0x00000001, 0x0000000A);
	}
	else
	{
...
struct<4> func_41(var uParam0)
{
	...
	iVar1 = unk_0x09AC81E49EA267F7(0x00000001, 0x00000015);
	*uParam0 = iVar1;
	StringIntConCat(&Var0, iVar1, 16);
	return Var0;
}
...
void func_51(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
		...
		func_58(0x00000001, iParam3, iParam2, 0x00000000);
	...
	else
	{
		...
		func_58(0x00000000, iParam3, iParam2, 0x00000000);
