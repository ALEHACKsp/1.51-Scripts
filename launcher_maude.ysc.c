...
void __EntryFunction__()
{
	...
	if (unk_0x2EBF608FFE6CA406(0x00000053))
	{
		...
		func_253(&Var0, 0x00000001);
	}
	iVar2[0x00000000] = 0x0000001F;
...
int func_232(var uParam0)
{
	...
	iVar0[0x00000000] = func_239(0x0000003E);
	iVar0[0x00000001] = 0xD3C6D323;
	iVar0[0x00000002] = 0x5293CC8D;
	switch (iLocal_51)
	{
		case 0x00000000:
			uParam0->f_10 = 0x00000005;
			uParam0->f_11[0x00000000 /*3*/] = { 2729.092f, 4143.17f, 41.36332f };
			uParam0->f_11[0x00000001 /*3*/] = { 2714.735f, 4145.382f, 45.30732f };
			uParam0->f_18 = 12.8f;
			uParam0->f_1B = 0x00000000;
			uParam0->f_19 = 0x00000001;
			StringCopy(&(uParam0->f_9), "MAUDE_MCS_1", 24);
			func_238(0x0000001F, 0x00000001, 0x00000001);
			iVar1 = 0x00000000;
		...
		case 0x00000002:
			...
			{
				func_236(&(uParam0->f_29[0x00000000]), iVar0[0x00000001], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0xC844350D5D58C99A(uParam0->f_29[0x00000001]))
			{
				func_236(&(uParam0->f_29[0x00000001]), iVar0[0x00000002], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!unk_0xC844350D5D58C99A(uParam0->f_1C[0x00000000]))
			{
				if (!func_233(&(uParam0->f_1C[0x00000000]), 0x0000003E, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 0x00000001))
				{
					bVar2 = 0x00000000;
				}
			}
		...
		case 0x00000003:
			if (func_126(uParam0->f_1C[0x00000000]) && func_127(uParam0->f_29[0x00000000]))
			{
				uParam0->f_3B = unk_0xE9744DB7B8CA6965(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 0x00000002);
				unk_0xC90224D9E95E5E3A(uParam0->f_3B, 0x00000001);
				unk_0xEFC3DF9D33E248D8(uParam0->f_3B, 0x00000000);
				unk_0x915804B434753CBD(uParam0->f_1C[0x00000000], uParam0->f_3B, "special_ped@maude@base", "base", 1000f, -4f, 0x00001250, 0x00000000, 0x447A0000, 0x00000000);
				...
				iVar3 += 512;
				iVar3 += 4096;
				unk_0xE14EC663EED44AD5(uParam0->f_29[0x00000000], uParam0->f_3B, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar3, 0x447A0000);
			}
			iVar1 = 0x00000000;
			while (iVar1 <= (iVar0 - 0x00000001))
			{
...
{
	if (func_234(iParam0, iParam1, vParam2, fParam3, 0x00000001))
	{
		if (unk_0xC844350D5D58C99A(*iParam0))
		{
			if (!unk_0x437347B10A200C4B(*iParam0, 0x00000000))
...
void func_238(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 0x0000001F:
			if (bParam1)
			{
				iLocal_52 = unk_0x7D6CA5F52B3748BF(vVar0, vVar1, 0x00000000, 0x00000001, 0x00000001, 0x00000001);
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	...
	if (*iParam0 == 0x00000001)
	{
		if (func_251((*iParam0)[0x00000000], vParam2, fParam3, iParam1))
		{
			return 0x00000001;
		}
	}
...
int func_251(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	...
	if (func_252(Var1.f_6, vParam1, fParam2, 0x00000000))
	{
...
void func_253(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		func_238(*iParam0, 0x00000000, 0x00000001);
		func_267(iParam0);
		func_255(iParam0, 0x00000000, 0x00000000, 0x00000000);
	}
...
void func_257(var uParam0, bool bParam1)
{
	...
	while (iVar0 <= (*uParam0 - 0x00000001))
	{
		...
		{
			func_258(uParam0[iVar0], 0x00000000);
		}
		iVar0++;
	}
}
...
void func_264(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 0x00000001))
	{
		...
		{
			func_265(uParam0[iVar0], 0x00000000, 0x00000001, 0x00000000);
		}
		iVar0++;
	}
}
...
void func_267(var uParam0)
{
	if (unk_0x69DF961355195C3C(uParam0->f_3B))
	{
		...
		{
			if (func_268(uParam0->f_1C[0x00000000], 0x6A67A5CC))
			{
		...
		if (func_127(uParam0->f_29[0x00000000]))
		{
			unk_0x1BF8B16C32704027(uParam0->f_29[0x00000000], -1000f, 0x00000001);
		}
	}
}
