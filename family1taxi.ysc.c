...
void func_1()
{
	...
	{
		case 0x00000000:
			if (((!unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0x00000000) && !unk_0x5327615940E385C1()) && !func_8()) && !func_7())
			{
		...
		case 0x00000001:
			...
			{
				SYSTEM::START_NEW_SCRIPT("taxiService", 0x00000724);
		...
		case 0x00000002:
			...
			{
				case 0x00000002:
					func_2("AM_H_TAXI1", 0x00000002, 0x00000000, 0x000003E8, 0x00002710, 0x00000001, 0x00000000, 0x00000000, 0x00000000);
					break;
		...
		case 0x00000003:
			...
			{
				case 0x00000002:
					func_2("AM_H_TAXI2", 0x00000002, 0x00000000, 0x000003E8, 0x00002710, 0x00000001, 0x00000000, 0x00000000, 0x00000000);
					break;
...
void func_10()
{
	...
	{
		func_11("AM_H_TAXI1", 0x00000001);
	}
	if (func_6("AM_H_TAXI2"))
	{
		func_11("AM_H_TAXI2", 0x00000001);
	}
...
void func_11(char* sParam0, int iParam1)
{
	...
	while (iVar0 < Global_1B416.f_4FB5.f_91)
	{
		if (unk_0x7F8A39872A07D2CE(sParam0, &(Global_1B416.f_4FB5[iVar0 /*16*/])))
		{
			...
			func_12((Global_1B416.f_4FB5.f_91 - 0x00000001));
