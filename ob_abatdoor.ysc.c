...
void __EntryFunction__()
{
	...
	{
		unk_0x1E9649458B15960F(iScriptParam_6, 0x00000001);
		vLocal_4 = { unk_0x68F4C0EC296D3901(iScriptParam_6, 0x00000001) };
		vLocal_5 = { unk_0x835730A2D89F6093(iScriptParam_6, 0x00000002) };
	}
	while (0x00000001)
	{
				...
				switch (iLocal_2)
				{
					case 0x00000000:
						if (unk_0x1A5AE8A9B1D42A10(iScriptParam_6))
						{
							...
							{
								if (!func_3(vLocal_4, 0f, 0f, 0f, 0x00000000))
								{
									iLocal_3 = unk_0x7707E48765093646(joaat("p_abat_roller_1_col"), vLocal_4, 0x00000001, 0x00000001, 0x00000000);
									unk_0xC023D1C4BF532815(iLocal_3, vLocal_5, 0x00000002, 0x00000001);
									iLocal_2 = 0x00000001;
								}
							}
						}
						...
						if (unk_0x1A5AE8A9B1D42A10(iScriptParam_6))
						{
							if (unk_0x8A22C4C08282BF26(joaat("michael2")) > 0x00000000)
							{
								if (Global_173C7)
								{
									if (unk_0xB4AE0788C1587752("map_objects"))
									{
										unk_0xD65E6E13E145467B(iScriptParam_6, "P_Abat_roller_1_open", "map_objects", 1f, 0x00000000, 0x00000001, 0x00000000, 0x00000000, 0x00000000);
										iLocal_2 = 0x00000003;
									}
								}
							}
					...
					case 0x00000003:
						...
						{
							vVar1 = { unk_0x68F4C0EC296D3901(iLocal_3, 0x00000001) };
							if (!func_2(vVar1, vVar0, 0.1f, 0x00000000))
							{
								vVar2 = { vVar0 - vVar1 };
								unk_0xA47B46945FF6DE74(iLocal_3, vVar1 + func_1(vVar2) * FtoV(unk_0x6117725E0134737F()) * Vector(fVar3, fVar3, fVar3), 0x00000001, 0x00000000, 0x00000000, 0x00000001);
							}
							else
							{
								Global_173C8 = 0x00000001;
								iLocal_2 = 0x00000004;
							}
						}
						break;
