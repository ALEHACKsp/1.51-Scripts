...
void func_1()
{
	if ((unk_0x1C0640BA9A7327B3() - iLocal_202) > 0x00001388)
	{
		if (func_2(&uLocal_37, "BARR4AU", "BARR4_AMB", 0x00000008, 0x00000000, 0x00000000, 0x00000000))
		{
			func_30();
		}
	}
...
void func_25()
{
	...
	func_26(&uLocal_37, 0x00000001, unk_0x16F2683693E537C9(), "FRANKLIN", 0x00000000, 0x00000001);
...
{
	if (((!func_14() == iParam0 || func_29()) || func_28()) || Global_12B4B != 0xFFFFFFFF)
	{
