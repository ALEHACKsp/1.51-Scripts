...
void __EntryFunction__()
{
	...
	while (0x00000001)
	{
		...
		func_184(&Var0, vVar1, "SAS1AUD", "SAS1_AMB", 0x00000004, "HUNTER", 0x00002710);
...
int func_184(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_175(0x00000002))
	{
		if (!func_146())
		{
			if (((func_127(unk_0x16F2683693E537C9()) && func_127(uParam0->f_1C[0x00000000])) && (unk_0x1C0640BA9A7327B3() - uParam0->f_3C) > iParam6) && func_190(unk_0x16F2683693E537C9(), vParam1, 0x00000001) < 20f)
			{
				uVar0 = 0x00000010;
				func_189(&uVar0, iParam4, uParam0->f_1C[0x00000000], sParam5, 0x00000000, 0x00000001);
				func_187(&uVar0, cParam2, sParam3, 0x00000007, 0x00000000, 0x00000000);
		...
		else if (func_185(sParam3))
		{
			...
			{
				if (func_190(unk_0x16F2683693E537C9(), vParam1, 0x00000001) >= 20f)
				{
					func_144();
				}
			}
...
{
	func_188(uParam0, 0x00000091, sParam1, iParam4, iParam5, 0x00000000);
...
void func_191(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam4, vector3 vParam5)
{
	...
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
	{
		if (!unk_0xEA6BC48857E0AC4C(sParam2))
		{
			...
			{
				if (func_190(unk_0x16F2683693E537C9(), vParam3, 0x00000001) <= 100f)
				{
			...
			{
				if (func_193(*iParam0) == 0x00000002)
				{
				...
				{
					fVar0 = func_190(unk_0x16F2683693E537C9(), vParam4, 0x00000001);
					fVar1 = func_190(unk_0x16F2683693E537C9(), vParam5, 0x00000001);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							if (*uParam1 != 0x00000001)
							{
								unk_0x5C8D148FC238F38A();
								unk_0x8E590B419F1E5182(sParam2, 0x00000005, 0x00000008);
								func_192(*iParam0, 0x00000001);
								*uParam1 = 0x00000001;
							}
						}
						else if (*uParam1 != 0x00000002)
						{
							unk_0x5C8D148FC238F38A();
							unk_0x8E590B419F1E5182(sParam2, 0x00000006, 0x00000008);
							func_192(*iParam0, 0x00000001);
							*uParam1 = 0x00000002;
						}
					}
				}
				if (func_190(unk_0x16F2683693E537C9(), vParam3, 0x00000001) > 120f)
				{
					func_195(iParam0);
				}
			}
...
int func_238(var uParam0)
{
	...
	iVar0[0x00000001] = joaat("dune");
	iVar0[0x00000002] = 0x47471492;
	switch (iLocal_51)
	{
		case 0x00000000:
			...
			unk_0x6D0C93EE4FBA9307(joaat("weapon_pumpshotgun"), 0x0000001F, 0x00000000);
			unk_0x6D0C93EE4FBA9307(joaat("weapon_sniperrifle"), 0x0000001F, 0x00000000);
		...
		case 0x00000002:
			bVar2 = 0x00000001;
			uParam0->f_1C[0x00000000] = unk_0x36F2404464202779(0x00000019, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, 0x00000001, 0x00000001);
			if (func_126(uParam0->f_1C[0x00000000]))
			{
				unk_0x262EF6C6306BEA6C(uParam0->f_1C[0x00000000], joaat("weapon_sniperrifle"), 0x00000064, 0x00000001, 0x00000001);
				unk_0xC6EB89C59F2AF6B8(uParam0->f_1C[0x00000000], "rcmlastone1", "idle_action_01", 8f, -8f, 0xFFFFFFFF, 0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x00000000);
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_23[0x00000000]))
			{
				func_239(&(uParam0->f_23[0x00000000]), iVar0[0x00000001], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (unk_0xC844350D5D58C99A(uParam0->f_23[0x00000000]))
				{
...
int func_252(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	...
	if (*iParam0 == 0x00000001)
	{
		if (func_253((*iParam0)[0x00000000], vParam2, fParam3, iParam1))
		{
			return 0x00000001;
		}
	}
...
int func_253(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	...
	if (func_254(Var1.f_6, vParam1, fParam2, 0x00000000))
	{
...
void func_255(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		func_257(iParam0, 0x00000000, 0x00000000, 0x00000000);
	}
...
void func_259(var uParam0, bool bParam1)
{
	...
	while (iVar0 <= (*uParam0 - 0x00000001))
	{
		...
		{
			func_260(uParam0[iVar0], 0x00000000);
		}
		iVar0++;
	}
}
...
void func_265(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 0x00000001))
	{
		...
		{
			func_266(uParam0[iVar0], 0x00000000, 0x00000001, 0x00000000);
		}
		iVar0++;
	}
}
