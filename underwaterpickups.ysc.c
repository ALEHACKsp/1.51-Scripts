...
void __EntryFunction__()
{
	...
	iLocal_2 = 0xFFFFFFFF;
	vVar0 = { ScriptParam_6.f_1[0x00000000 /*3*/] };
	...
	func_24(vVar0);
	bLocal_4 = func_4();
	vLocal_5 = { unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0x00000000) };
	func_1();
	while (0x00000001)
	{
...
void func_1()
{
	...
	while (iVar0 < 0x00000014)
	{
		...
		{
			if (func_2(vVar3, 0f, 0f, 0f, 0x00000000))
			{
				iVar4 = 0x00000000;
				unk_0x5D96D8530B3D0904(&iVar4, 0x00000001);
				unk_0x5D96D8530B3D0904(&iVar4, 0x00000004);
				unk_0x5D96D8530B3D0904(&iVar4, 0x00000003);
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0xA6FF0828D17CF374(iVar1, vVar2, iVar4, iVar5, 0x00000001, 0x00000000);
					}
				}
				else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = unk_0xA6FF0828D17CF374(iVar1, vVar2, iVar4, 0xFFFFFFFF, 0x00000001, 0x00000000);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x2D7B5CDDF12654D2(iVar1, vVar2, vVar3, iVar4, 0x00002710, 0x00000002, 0x00000001, 0x00000000);
					}
				}
				else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = unk_0x2D7B5CDDF12654D2(iVar1, vVar2, vVar3, iVar4, 0xFFFFFFFF, 0x00000002, 0x00000001, 0x00000000);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
int func_4()
{
	if (Global_259192 == 0xFFFFFFF1)
	{
		Global_259192 = func_23();
		func_15(&Global_259192, 0x00000000, 0x00000000, 0x00000000, 0x00000001, 0x00000000, 0x00000000);
		return 0x00000001;
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 0x0000001A) & 0x0000001F * func_12(unk_0xEAE0D21A50E6C7F4(iParam0, 0x0000001F), 0xFFFFFFFF, 0x00000001)) + 2011;
}
...
int func_13(int iParam0)
{
	...
	if (iVar5 < 0x00000001 || iVar5 > func_14(iVar4, iVar3))
	{
		return 0x00000000;
	}
	return 0x00000001;
...
void func_18(var uParam0, int iParam1)
{
	...
	if (iParam1 < 0x00000001 || iParam1 > func_14(iVar0, iVar1))
	{
		return;
	}
...
void func_24(vector3 vParam0)
{
	...
	vVar0[0x00000000 /*3*/] = { -1029f, 6517f, -21f };
	vVar0[0x00000001 /*3*/] = { 3265f, 6407f, -47f };
	vVar0[0x00000002 /*3*/] = { 4215f, 3603f, -48f };
	vVar0[0x00000003 /*3*/] = { -3247f, 3669f, -28f };
	vVar0[0x00000004 /*3*/] = { -3192f, 3029f, -35f };
	vVar0[0x00000005 /*3*/] = { -2838f, -446f, -38f };
	vVar0[0x00000006 /*3*/] = { 3156f, -307f, -17f };
	vVar0[0x00000007 /*3*/] = { 2695f, -1334f, -26f };
	vVar0[0x00000008 /*3*/] = { 264f, -2280f, -8f };
	vVar0[0x00000009 /*3*/] = { 1804f, -2993f, -46f };
	vVar0[0x0000000A /*3*/] = { -131f, -2867f, -10f };
	vVar0[0x0000000B /*3*/] = { 3595f, 3041f, -15f };
	iVar1 = 0x00000000;
	while (iVar1 <= (0x0000000C - 0x00000001))
	{
		if (func_25(vParam0, vVar0[iVar1 /*3*/], 0x3F000000, 0x00000000))
		{
			iLocal_2 = iVar1;
			return;
		}
