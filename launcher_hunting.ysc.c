...
void __EntryFunction__()
{
	...
	iVar2[0x00000000] = 0x00000019;
	iVar2[0x00000001] = 0x0000001A;
	...
	unk_0x536F1BE96C726C4B(vVar1, 3f, 0x00000001, 0x00000000, 0x00000000, 0x00000000);
	while (0x00000001)
	{
		SYSTEM::WAIT(0x00000000);
		if (!func_197(&Var0, 0x00000001))
		{
			func_260(&Var0, 0x00000001);
		}
		func_196(Var0);
		...
		if (Var0 == 0x00000019)
		{
			func_184(&Var0, vVar1, "HUNT1AU", "HUNT1_AMB", 0x00000003, "CLETUS", 0x00001388, 0x41A00000);
		}
		...
		if (func_169(&Var0, 0x00000000) && unk_0x755FF954DAE327E1((vVar1.z - vVar3.z)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 0x00000001);
...
int func_2(int iParam0)
{
	...
	if (!func_168())
	{
		while (!func_159(*iParam0))
		{
			...
			if (!func_197(iParam0, *iParam0 != 0x00000002))
			{
...
void func_107(char* sParam0, var uParam1, int iParam2)
{
	...
	unk_0x1AE6E2984A30CB9E(sParam0, uParam1, iParam2, func_108(0x00000000));
}
...
int func_184(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(iParam0->f_1C[0x00000000])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_3C) > iParam6) && func_188(unk_0x16F2683693E537C9(), vParam1, 0x00000001) < fParam7)
	{
		uVar0 = 0x00000010;
		func_187(&uVar0, iParam4, iParam0->f_1C[0x00000000], sParam5, 0x00000000, 0x00000001);
		func_185(&uVar0, cParam2, sParam3, 0x00000007, 0x00000000, 0x00000000);
...
{
	func_186(uParam0, 0x00000091, sParam1, iParam4, iParam5, 0x00000000);
...
float func_188(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
int func_197(int iParam0, bool bParam1)
{
	...
	func_110(*iParam0, &Var0);
	if ((func_234(*iParam0) || func_232(*iParam0)) || Global_12C43 == 0x00000001)
	{
		return 0x00000001;
	}
	if (!unk_0x338D6FF72D84D90F())
	...
	if (func_228(*iParam0))
	{
		...
		{
			func_227(iParam0->f_1C[0x00000000]);
		}
	...
	{
		if (!func_207(iParam0, 0x00000001, 0x00000000))
		{
			return 0x00000000;
		}
	}
	...
	{
		if (!func_207(iParam0, 0x00000000, 0x00000000))
		{
			return 0x00000000;
		}
	}
	...
	{
		if (!func_205(iParam0, 0x00000001, 0x00000001))
		{
	...
	{
		if (!func_205(iParam0, 0x00000000, 0x00000001))
		{
			func_202(iParam0);
			return 0x00000000;
		}
	...
	{
		if (!func_205(iParam0, 0x00000001, 0x00000000))
		{
			func_202(iParam0);
			return 0x00000000;
		}
	...
	{
		if (!func_205(iParam0, 0x00000000, 0x00000000))
		{
			func_202(iParam0);
			return 0x00000000;
		}
	...
	{
		func_198(iParam0->f_1C[0x00000000], &(iParam0->f_30), *iParam0);
	}
	return 0x00000001;
}
...
void func_198(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 0x00000002:
				if (!func_200(uParam1) || !unk_0xB4ECF989E2C1DAC8(iParam0, *uParam1, uParam1->f_2, 0x00000003))
				{
					...
					else if ((func_200(uParam1) && uParam1->f_4 == 0x00000000) && unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0x00000001), unk_0x68F4C0EC296D3901(iParam0, 0x00000001), 0x00000001) < 20f)
					{
...
void func_202(var uParam0)
{
	...
	{
		func_203(&(uParam0->f_29[0x00000001]));
		func_203(&(uParam0->f_29[0x00000002]));
	}
			...
			if (unk_0xC844350D5D58C99A(uParam0->f_1C[iVar0]))
			{
				if (!unk_0xEB6A8945D1AC98A1(uParam0->f_1C[iVar0]))
				{
					...
					if (func_226(*uParam0))
					{
						if (!func_158(*uParam0))
						{
							if (func_221(uParam0->f_1C[iVar0], 0x00000001, 0x00000000, 0x00000000, 0x00000000))
							{
								if (iParam2 == 0x00000000)
								{
									func_202(uParam0);
						...
						if (func_209(uParam0->f_1C[iVar0], 0x432A0000))
						{
							if (iParam2 == 0x00000000)
							{
								func_202(uParam0);
...
{
	return func_211(iParam0, unk_0x16F2683693E537C9(), fParam1, 0x00000001, 0x000000FA, 0x00000007);
}
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_217(unk_0x68F4C0EC296D3901(iParam1, 0x00000001) - unk_0x68F4C0EC296D3901(iParam0, 0x00000001)) };
	...
	{
		vVar1 = { func_217(unk_0x64430C979F516F7A(iParam0, 0x0000796E, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 0x0000796E, 0f, 0f, 0f)) };
	}
...
int func_223(int iParam0, float fParam1)
{
	...
	{
		if (func_224(iParam0, vVar1, 90f, 0x00000000))
		{
			return 0x00000001;
		}
	}
...
int func_224(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_217(vParam1 - unk_0x68F4C0EC296D3901(iParam0, 0x00000001)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 0x00000001;
	}
...
{
	if ((func_233() && Global_181B8.f_B == 0x00000006) && iParam0 == func_167(&(Global_181B8.f_3), 0x00000000))
	{
		return 0x00000001;
	}
	return 0x00000000;
...
int func_236(var uParam0)
{
	...
	iVar0[0x00000003] = iLocal_55;
	iVar0[0x00000004] = iLocal_56;
	switch (iLocal_51)
	{
		case 0x00000000:
		...
		case 0x00000002:
			...
			{
				if (func_240(&(uParam0->f_1C[0x00000000]), 0x00000036, -683.3276f, 5841.042f, 17.217f, 8.33f, "RC HUNTER 2", 0x00000001))
				{
					unk_0x262EF6C6306BEA6C(uParam0->f_1C[0x00000000], joaat("weapon_pumpshotgun"), 0x00000000, 0x00000001, 0x00000001);
				}
				else
				{
					bVar2 = 0x00000000;
			...
			{
				func_237(&(uParam0->f_23[0x00000000]), -685.2281f, 5833.982f, 16.331f, 313.2204f, 0x00000000);
			}
			if (!unk_0xC844350D5D58C99A(iLocal_58))
			{
				iLocal_58 = unk_0x5ACD4E66C7BF0F49(joaat("weapon_sniperrifle"), 0x00000000, vLocal_57, 0x00000000, 0x3F800000, 0x00000000, 0x00000000, 0x00000001);
		...
		case 0x00000003:
			if (func_127(uParam0->f_1C[0x00000000]))
			{
				...
				{
					unk_0x3E8E48829F3C7624(uParam0->f_1C[0x00000000], "rcmhunting2", "_idle_loop", -683.152f, 5841.281f, 17.32f, 0f, 0f, 17.024f, 1000f, -8f, 0xFFFFFFFF, 0x000C1009, 0f, 0x00000002, 0x00000001);
				}
			}
			unk_0x0C8C0C840C2D1AD2(uParam0->f_1C[0x00000000], unk_0x16F2683693E537C9(), 0xFFFFFFFF, 0x00000C10, 0x00000002);
			if (unk_0xBF75E4DF4C367CD9(vLocal_57, 1f, iLocal_54, 0x00000000))
			{
				unk_0xC023D1C4BF532815(iLocal_58, 0f, -90f, -162.64f, 0x00000002, 0x00000001);
			}
			iVar1 = 0x00000000;
			while (iVar1 <= (iVar0 - 0x00000001))
			{
...
void func_237(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	if (unk_0xC844350D5D58C99A(*iParam0))
	{
		...
		unk_0xD3421E391490133B(*iParam0, 0x00000002, 0x00000000);
		unk_0xD3421E391490133B(*iParam0, 0x00000003, 0x00000001);
...
{
	if (func_241(iParam0, iParam1, vParam2, fParam3, 0x00000001))
	{
		if (unk_0xC844350D5D58C99A(*iParam0))
		{
			if (!unk_0x437347B10A200C4B(*iParam0, 0x00000000))
...
int func_244(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0x00000000:
			...
			func_246(&(uParam0->f_30), "special_ped@cletus@base", "cletus_base", 0x00000000);
		...
		case 0x00000002:
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_1C[0x00000000]))
			{
				if (func_240(&(uParam0->f_1C[0x00000000]), 0x00000036, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 0x00000001))
				{
					unk_0x262EF6C6306BEA6C(uParam0->f_1C[0x00000000], joaat("weapon_sniperrifle"), 0x00000000, 0x00000001, 0x00000001);
				}
				else
				{
					bVar2 = 0x00000000;
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_23[0x00000000]))
			{
				func_237(&(uParam0->f_23[0x00000000]), 1806.732f, 3934.353f, 33.3275f, 76.1155f, 0x00000000);
				unk_0x28F5E4DA506AC0CA(1804.501f, 3922.917f, 32.8091f, 2f, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000);
			}
			if (bVar2)
			{
				iLocal_51 = 0x00000003;
		...
		case 0x00000003:
			if (func_127(uParam0->f_1C[0x00000000]))
			{
				unk_0x1F6FCCC72D02C71A(uParam0->f_1C[0x00000000], joaat("weapon_sniperrifle"), joaat("component_at_ar_supp_02"));
				unk_0x4E885A246A9D983A(uParam0->f_1C[0x00000000], 0x00000068, 0x00000001);
				unk_0x5745EA6329A91E29(uParam0->f_1C[0x00000000], joaat("weapon_sniperrifle"), 0x00000001);
				if (unk_0xB4AE0788C1587752("special_ped@cletus@base"))
				{
					unk_0xC6EB89C59F2AF6B8(uParam0->f_1C[0x00000000], "special_ped@cletus@base", "cletus_base", 8f, -8f, 0xFFFFFFFF, 0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x00000000);
				}
			}
			unk_0x745CE398A4B0A3C6(1801.159f, 3919.606f, 33.0662f, 5f, 0x00000000);
			unk_0x10F3BFFADF2CE3DA(1803.603f, 3920.191f, 32.9855f, 1798.416f, 3918.291f, 35.0579f);
			unk_0x745CE398A4B0A3C6(1797.286f, 3927.359f, 33.0176f, 4f, 0x00000000);
			...
			{
				unk_0xCD7D80FD792F9954("WORLD_HUMAN_HANG_OUT_STREET", 0x00000000);
			}
			if (unk_0x035491B0E495A4C1("WORLD_HUMAN_DRINKING"))
			{
				unk_0xCD7D80FD792F9954("WORLD_HUMAN_DRINKING", 0x00000000);
			}
			if (unk_0x035491B0E495A4C1("WORLD_HUMAN_SMOKING"))
			{
				unk_0xCD7D80FD792F9954("WORLD_HUMAN_SMOKING", 0x00000000);
			}
			iVar1 = 0x00000000;
			while (iVar1 <= (iVar0 - 0x00000001))
			{
...
int func_257(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	...
	if (*iParam0 == 0x00000001)
	{
		if (func_258((*iParam0)[0x00000000], vParam2, fParam3, iParam1))
		{
			return 0x00000001;
		}
	}
...
int func_258(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	...
	if (func_259(Var1.f_6, vParam1, fParam2, 0x00000000))
	{
...
void func_260(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		func_261(iParam0, 0x00000000, 0x00000000, 0x00000000);
	}
...
void func_263(var uParam0, bool bParam1)
{
	...
	while (iVar0 <= (*uParam0 - 0x00000001))
	{
		...
		{
			func_264(uParam0[iVar0], 0x00000000);
		}
		iVar0++;
	}
}
...
void func_269(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 0x00000001))
	{
		...
		{
			func_270(uParam0[iVar0], 0x00000000, 0x00000001, 0x00000000);
		}
		iVar0++;
	}
}
