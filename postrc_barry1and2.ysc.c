...
void __EntryFunction__()
{
	...
	unk_0xD7992BEF7A9D109E("BARY1", 0x00000007);
	while (!unk_0xB4AE0788C1587752(sLocal_44) || !unk_0x67C1D9E5B91B2E37(0x00000007))
	{
		unk_0x38C3A68D7861DCFD(0x00000000, 0x0000001A, 0x00000001);
	...
	iLocal_47 = unk_0x09AC81E49EA267F7(0x00000000, 0x00000005);
	func_19();
	while (!func_13(&iLocal_43, 0x00000031, vLocal_50, func_18(1.12f), 0x00000000))
	{
		unk_0x38C3A68D7861DCFD(0x00000000, 0x0000001A, 0x00000001);
		SYSTEM::WAIT(0x00000000);
	}
	...
	while (0x00000001)
	{
		...
		if (func_2(unk_0x16F2683693E537C9(), vLocal_50, 0x00000001) > 70f)
		{
			func_1(&iLocal_40, 0x00000000);
			func_1(&iLocal_41, 0x00000000);
			func_1(&iLocal_42, 0x00000000);
			func_22(0x00000000);
		}
		SYSTEM::WAIT(0x00000000);
	}
...
float func_2(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
...
int func_3()
{
	...
	if (((((func_10(unk_0x16F2683693E537C9()) && func_10(iLocal_43)) && !func_9()) && unk_0x1C0640BA9A7327B3() > iLocal_46) && func_8(unk_0x16F2683693E537C9(), iLocal_43, 0x00000001) < 20f) && !unk_0x2C1AA3A291786CDC())
	{
		uVar0 = 0x00000010;
		func_7(&uVar0, 0x00000000, iLocal_43, "BARRY", 0x00000000, 0x00000001);
		func_4(&uVar0, "BARY1AU", func_6(), 0x00000007, 0x00000000, 0x00000000);
		iLocal_46 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(0x00002EE0, 0x00004650));
		return 0x00000001;
	}
	return 0x00000000;
}
...
{
	func_5(uParam0, 0x00000091, sParam1, iParam4, iParam5, 0x00000000);
...
void func_11()
{
	if (unk_0x681F21BF9F7B449B(0xFFFFFFFF, vLocal_50, 5f))
	{
		if (func_10(iLocal_43))
		{
			unk_0x1E9649458B15960F(iLocal_43, 0x00000000);
			unk_0xCEE7E5D42799D65A(iLocal_43, 0x000003E8, 0x00000001, 0x00000000);
		}
...
void func_12()
{
	if (func_10(iLocal_43))
	{
		...
		{
			unk_0x73270B3C9CC833FD(iLocal_43, 0x00000001, 0x00000000);
		}
		unk_0x9A28E8CB86CD4694(iLocal_43, 0x00000001, 0x00000000, 0x00000000, 0x00000000);
		unk_0x11AD11297DC58CC7(iLocal_43, 0x00000001);
		unk_0x6D80F1AEBA734886(iLocal_43, 0x00000000);
		unk_0x25C5402CC10F76CD(iLocal_43, 0x00000000);
		unk_0x5F2AA9E2843E9403(iLocal_43, "POSTBARRY");
		unk_0x6DF7BF67E86AAE86(iLocal_43, 0x6F0783F5);
		unk_0x20641932E5104B25(iLocal_43, 0x00000000, 0x00000000);
		unk_0x1E9649458B15960F(iLocal_43, 0x00000001);
		unk_0xA47B46945FF6DE74(iLocal_43, vLocal_50, 0x00000001, 0x00000000, 0x00000000, 0x00000001);
		unk_0xD8F6A53F4799FAFE(iLocal_43, func_18(1.12f));
		unk_0x1E9649458B15960F(iLocal_43, 0x00000001);
		unk_0xC6EB89C59F2AF6B8(iLocal_43, sLocal_44, sLocal_45, 8f, -8f, 0xFFFFFFFF, 0x00000009, 0x00000000, 0x00000000, 0x00000000, 0x00000000);
		unk_0x0C8C0C840C2D1AD2(iLocal_43, unk_0x16F2683693E537C9(), 0xFFFFFFFF, 0x00000000, 0x00000002);
	}
}
...
void func_19()
{
	if (unk_0xBF75E4DF4C367CD9(190.56f, -956.4f, 28.63f, 20f, joaat("prop_protest_table_01"), 0x00000000))
	{
		iLocal_41 = unk_0x4B72871A3BE7B474(190.56f, -956.4f, 28.63f, 20f, joaat("prop_protest_table_01"), 0x00000000, 0x00000000, 0x00000001);
		if (func_25(iLocal_41))
		{
			...
			unk_0xA47B46945FF6DE74(iLocal_41, vLocal_49, 0x00000001, 0x00000000, 0x00000000, 0x00000001);
			unk_0xD8F6A53F4799FAFE(iLocal_41, func_18(-2.01f));
			unk_0x1E9649458B15960F(iLocal_41, 0x00000001);
		}
	}
	if (unk_0xBF75E4DF4C367CD9(190.56f, -956.4f, 28.63f, 20f, joaat("prop_chair_08"), 0x00000000))
	{
		iLocal_40 = unk_0x4B72871A3BE7B474(190.56f, -956.4f, 28.63f, 20f, joaat("prop_chair_08"), 0x00000000, 0x00000000, 0x00000001);
		if (func_25(iLocal_40))
		{
			...
			unk_0xA47B46945FF6DE74(iLocal_40, vLocal_49, 0x00000001, 0x00000000, 0x00000000, 0x00000001);
	...
	if (unk_0xBF75E4DF4C367CD9(vLocal_49, 25f, joaat("prop_protest_sign_01"), 0x00000000))
	{
		iLocal_42 = unk_0x4B72871A3BE7B474(vLocal_49, 25f, joaat("prop_protest_sign_01"), 0x00000000, 0x00000000, 0x00000001);
		if (func_25(iLocal_42))
		{
			...
			vLocal_49.z = 29.603f;
			unk_0xA47B46945FF6DE74(iLocal_42, vLocal_49, 0x00000001, 0x00000000, 0x00000000, 0x00000001);
...
void func_22(bool bParam0)
{
	...
	{
		func_23(&iLocal_43, 0x00000001, 0x00000000, 0x00000001);
	}
	if (func_10(iLocal_41))
	{
		unk_0x1E9649458B15960F(iLocal_41, 0x00000000);
	...
	unk_0x11CCD0ACA866C6C5(0x00000007, 0x00000000);
