...
void __EntryFunction__()
{
	...
	fLocal_25 = -0.0375f;
	fLocal_26 = 0.17f;
	iLocal_28 = 0x0000004D;
	iLocal_29 = 0x000000C2;
	iLocal_30 = 0x00000034;
	iLocal_28 = 0x0000004D;
	if (unk_0x8A22C4C08282BF26(joaat("rampage_controller")) > 0x00000001)
	{
	...
	{
		func_27((iLocal_29 + iVar0), 0x00000000, 0x00000000);
		unk_0x5D96D8530B3D0904(&(Global_1B416.f_4889[(iLocal_30 + iVar0) /*6*/]), 0x00000003);
		iVar0++;
	}
	func_19(0x00000001);
	while (0x00000001)
	{
		...
		if (!func_18(0x00000028))
		{
			switch (func_16("RAMP_NEW_ALL"))
			{
				case 0x00000002:
					func_13("RAMP_NEW_ALL", 0x00000001, 0x00000000, 0x000007D0, 0x00002710, 0x00000004, 0x00000000, 0x00000000, 0x00000000);
					break;
...
bool func_1()
{
	return (((func_9(0x00000009) || Global_7832) || func_2() != 0x00000002) || Global_1B085[0x00000038 /*10*/].f_3);
}
...
void func_19(bool bParam0)
{
	...
	while (iVar0 < 0x00000005)
	{
		...
		func_26(iVar1, bParam0, 0x00000000);
		func_24(iVar1, 0x00000001, 0x00000002, 0x00000000);
		func_23(iVar1, 0x00000001);
		func_22(iVar1, 0x0000002C);
		if (((Global_1B416.f_92B[iVar0 /*2*/] >= 0x00000001 || func_36(0x0000006C) == 0x00000001) || func_21((iLocal_29 + iVar0), 0x00000000)) || unk_0xEAE0D21A50E6C7F4(Global_1B416.f_4889[(iLocal_30 + iVar0) /*6*/], 0x00000003))
		{
...
void func_27(int iParam0, int iParam1, int iParam2)
{
	...
	{
		func_33((0x0000037B + iParam0), 0x00000001, 0xFFFFFFFF, 0x00000001);
	}
	bVar0 = 0x00000001;
	if (Global_1B416.f_27CD[iParam0 /*12*/].f_5 == 0x00000001)
	{
...
void func_28()
{
	...
	{
		func_32(0x0000000D, SYSTEM::FLOOR(Global_1B416.f_27CD.f_F0D));
	}
	if (!unk_0xBA972B2C9F1D30C1())
	{
		if (!Global_12B4E)
		{
			if (func_31() == 0x00000002 == 0x00000000 && !unk_0x8CD06866876216F2())
			{
